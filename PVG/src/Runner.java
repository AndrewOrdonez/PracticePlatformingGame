...
public class Runner {
	...
	public static void main(String[] args) throws InterruptedException
	{
	  ...
	  //code for adding rooms
	    ...
	    RoomProtocols.roomList.add(new Room(3,3));
	    RoomProtocols.roomList.get(3).setSpawn(0, 400, 0);
	    RoomProtocols.roomList.get(3).setSpawn(1, 10, 420);
	    RoomProtocols.roomList.get(3).setSpawn(2, 980, 420);
	    RoomProtocols.roomList.add(new Room(4,2));
	    RoomProtocols.roomList.get(4).setSpawn(0, 10, 420);
	    RoomProtocols.roomList.get(4).setSpawn(1, 980, 400);
	    RoomProtocols.roomList.add(new Room(5,1));
	    RoomProtocols.roomList.get(5).setSpawn(0, 980, 420);
	    //code for work:
	    while (true){
